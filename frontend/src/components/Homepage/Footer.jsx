    ...
    <footer className="bg-gray-950 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">CheckIn</h3>
            <p className="text-gray-400">
              Revolutionizing hotel management with cutting-edge technology and intuitive solutions.
            </p>
          </div>
          <div>
          ...
          <div>
            <h4 className="font-semibold mb-4 mr-4">Connect With Us</h4>
